Youngseokcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/youngseokcoin/files/Youngseokcoin/youngseokcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Youngseokcoin
...
New/changed settings (command-line or youngseokcoin.conf file)
--------------------------------------------------------
