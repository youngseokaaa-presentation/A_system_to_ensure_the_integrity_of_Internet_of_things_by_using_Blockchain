Youngseokcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/youngseokcoin/files/Youngseokcoin/youngseokcoin-0.5.4/
...
http://gitorious.org/youngseokcoin/youngseokcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Youngseokcoin-Qt notifications under Growl 1.3.
Increase required age of Youngseokcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxYoungseokcoin properly when installing Youngseokcoin-Qt over it. (Windows)
