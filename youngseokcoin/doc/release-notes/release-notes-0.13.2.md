Youngseokcoin Core version 0.13.2 is now available from:

  <https://youngseokcoin.org/bin/youngseokcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update youngseokcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow youngseokcoin-tx to create v2 transactions (yscdrak)
