Youngseokcoin Core version 0.9.2.1 is now available from:

  https://youngseokcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 YSC to 0.01 YSC
...
- Fix "Start youngseokcoin on system login"
