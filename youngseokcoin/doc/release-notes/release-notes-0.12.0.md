...
Then, to tunnel a SSL connection on 28486 to a RPC server bound on localhost on port 18486 do:

    stunnel -d 28486 -r 127.0.0.1:18486 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /youngseokcoinrpc>
        ProxyPass http://127.0.0.1:8486/
        ProxyPassReverse http://127.0.0.1:8486/
