Youngseokcoin Core version 0.9.4 is now available from:

  https://youngseokcoin.org/bin/0.9.4/
...
this update is incompatible with the Youngseokcoin system and could lead to consensus
forks.

Youngseokcoin Core released binaries from https://youngseokcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~youngseokcoin/+archive/ubuntu/youngseokcoin
- A third-party or self-compiled Youngseokcoin Core

upgrade to Youngseokcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
