Youngseokcoin Core version 0.10.4 is now available from:

  <https://youngseokcoin.org/bin/youngseokcoin-core-0.10.4/>
...
- #6953 `43c2789` Split youngseokcoin-tx into its own package
- #6953 `dfe0d4d` Include youngseokcoin-tx binary on Debian/Ubuntu
