...
{
    BOOST_CHECK(TestSplitHost("www.youngseokcoin.org", "www.youngseokcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.youngseokcoin.org]", "www.youngseokcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.youngseokcoin.org:80", "www.youngseokcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.youngseokcoin.org]:80", "www.youngseokcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8487", "127.0.0.1", 8487));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8487", "127.0.0.1", 8487));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8487", "::ffff:127.0.0.1", 8487));
    BOOST_CHECK(TestSplitHost("[::]:8487", "::", 8487));
    BOOST_CHECK(TestSplitHost("::8487", "::8487", -1));
    BOOST_CHECK(TestSplitHost(":8487", "", 8487));
    BOOST_CHECK(TestSplitHost("[]:8487", "", 8487));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8487", "127.0.0.1:8487"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8487", "[::]:8487"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
