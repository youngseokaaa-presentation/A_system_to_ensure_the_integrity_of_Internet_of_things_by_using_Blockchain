...
const std::string strMessageMagic = "Youngseokcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s YSC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("youngseokcoin-scriptch");
