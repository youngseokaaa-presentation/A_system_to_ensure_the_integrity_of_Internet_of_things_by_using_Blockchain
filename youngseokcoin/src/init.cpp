...
void Shutdown()
{
    ...
    RenameThread("youngseokcoin-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), YOUNGSEOKCOIN_PID_FILENAME));
#endif
...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<https://youngseokcoincore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("youngseokcoin-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Youngseokcoin version %s\n", FormatFullVersion());
}
