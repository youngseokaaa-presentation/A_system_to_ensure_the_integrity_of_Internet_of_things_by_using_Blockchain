...
unlocked to sign the Youngseokcoin-Qt.app bundle.
...
allowing somebody to distribute a Youngseokcoin-Qt.app or youngseokcoin-qt-setup.exe with a valid
...
that the youngseokcoin-qt.exe file inside the installer had not been tampered with.
